...
This electronic version of Etch-A-Sketch is designed to have some resemblance to the original machine, but allows for the creation of both lineographic and non-lineographic images,using a square grid of adjustable resolution (total number of squares, or _grid size_), and has many, many more advanced [features](#features).
